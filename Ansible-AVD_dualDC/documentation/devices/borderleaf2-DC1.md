...
| --------- | --------------- | ------------ | --------- |
| mlag3-DC1 | Vlan4094 | 10.255.252.8 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_borderleaf1-DC1_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_borderleaf1-DC1_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-DC1_Ethernet7 | routed | - | 192.168.103.49/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-DC1_Ethernet7 | routed | - | 192.168.103.51/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3-DC1_Ethernet7 | routed | - | 192.168.103.53/31 | default | 1550 | False | - | - |
| Ethernet12 | P2P_LINK_TO_DCI_Ethernet2 | routed | - | 172.31.252.2/31 | default | 1550 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_borderleaf1-DC1_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.101.7/32 |
...
| 172.31.252.3 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
| 192.168.103.48 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.103.50 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.103.52 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.101.7:20 | 20:20 | - | - | learned |
| 20 | 192.168.101.7:30 | 30:30 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Spock | 192.168.101.7:1000 | connected |
...
router bgp 65103
   ...
   neighbor 172.31.252.3 remote-as 65000
   neighbor 172.31.252.3 description DCI
   ...
   neighbor 192.168.103.48 description spine1-DC1_Ethernet7
   neighbor 192.168.103.50 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.50 remote-as 65100
   neighbor 192.168.103.50 description spine2-DC1_Ethernet7
   neighbor 192.168.103.52 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.52 remote-as 65100
   neighbor 192.168.103.52 description spine3-DC1_Ethernet7
