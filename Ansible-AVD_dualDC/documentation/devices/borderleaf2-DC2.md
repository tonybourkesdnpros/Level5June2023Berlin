...
| --------- | --------------- | ------------ | --------- |
| mlag3-DC2 | Vlan4094 | 10.255.252.8 | Port-Channel1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-DC2_Ethernet7 | routed | - | 192.168.203.49/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-DC2_Ethernet7 | routed | - | 192.168.203.51/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3-DC2_Ethernet7 | routed | - | 192.168.203.53/31 | default | 1550 | False | - | - |
| Ethernet12 | P2P_LINK_TO_DCI_Ethernet4 | routed | - | 172.31.252.6/31 | default | 1550 | False | - | - |
...
interface Ethernet5
   ...
   mtu 1550
   no switchport
   ip address 192.168.203.53/31
!
interface Ethernet12
   description P2P_LINK_TO_DCI_Ethernet4
   no shutdown
   mtu 1550
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.201.7/32 |
...
| Vlan3999 |  Spock  |  10.255.251.9/31  |  -  |  -  |  -  |  -  |  -  |
...
| 172.31.252.7 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
| 192.168.203.48 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.203.50 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.203.52 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 10.255.251.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Spock | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.201.7:20 | 20:20 | - | - | learned |
| 20 | 192.168.201.7:30 | 30:30 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Spock | 192.168.201.7:1000 | connected |
...
router bgp 65103
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description borderleaf1-DC2
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 10.255.251.8 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.251.8 description borderleaf1-DC2
   neighbor 172.31.252.7 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.252.7 remote-as 65000
   neighbor 172.31.252.7 local-as 65203 no-prepend replace-as
   neighbor 172.31.252.7 description DCI
   ...
   neighbor 192.168.203.48 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.48 remote-as 65200
   neighbor 192.168.203.48 description spine1-DC2_Ethernet7
   neighbor 192.168.203.50 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.50 remote-as 65200
   neighbor 192.168.203.50 description spine2-DC2_Ethernet7
   neighbor 192.168.203.52 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.52 remote-as 65200
   neighbor 192.168.203.52 description spine3-DC2_Ethernet7
