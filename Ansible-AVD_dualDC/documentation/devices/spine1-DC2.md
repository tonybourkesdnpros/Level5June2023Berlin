...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_LEAF1-DC2_Ethernet3 | routed | - | 192.168.203.0/31 | default | 1550 | False | - | - |
| Ethernet3 | P2P_LINK_TO_LEAF2-DC2_Ethernet3 | routed | - | 192.168.203.6/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_LINK_TO_LEAF3-DC2_Ethernet3 | routed | - | 192.168.203.12/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_LINK_TO_LEAF4-DC2_Ethernet3 | routed | - | 192.168.203.18/31 | default | 1550 | False | - | - |
| Ethernet6 | P2P_LINK_TO_BORDERLEAF1-DC2_Ethernet3 | routed | - | 192.168.203.32/31 | default | 1550 | False | - | - |
| Ethernet7 | P2P_LINK_TO_BORDERLEAF2-DC2_Ethernet3 | routed | - | 192.168.203.48/31 | default | 1550 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.201.11/32 |
...
| 192.168.201.3 | 65202 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - |
| 192.168.201.4 | 65202 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - |
...
| 192.168.203.1 | 65201 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.203.7 | 65201 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.203.13 | 65202 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.203.19 | 65202 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.203.33 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.203.49 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
router bgp 65200
   ...
   neighbor 192.168.203.1 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.1 remote-as 65201
   neighbor 192.168.203.1 description leaf1-DC2_Ethernet3
   neighbor 192.168.203.7 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.7 remote-as 65201
   neighbor 192.168.203.7 description leaf2-DC2_Ethernet3
   neighbor 192.168.203.13 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.13 remote-as 65202
   neighbor 192.168.203.13 description leaf3-DC2_Ethernet3
   neighbor 192.168.203.19 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.19 remote-as 65202
   neighbor 192.168.203.19 description leaf4-DC2_Ethernet3
   neighbor 192.168.203.33 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.33 remote-as 65103
   neighbor 192.168.203.33 description borderleaf1-DC2_Ethernet3
   neighbor 192.168.203.49 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.49 remote-as 65103
   neighbor 192.168.203.49 description borderleaf2-DC2_Ethernet3
