...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_LEAF1-DC2_Ethernet5 | routed | - | 192.168.203.4/31 | default | 1550 | False | - | - |
| Ethernet3 | P2P_LINK_TO_LEAF2-DC2_Ethernet5 | routed | - | 192.168.203.10/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_LINK_TO_LEAF3-DC2_Ethernet5 | routed | - | 192.168.203.16/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_LINK_TO_LEAF4-DC2_Ethernet5 | routed | - | 192.168.203.22/31 | default | 1550 | False | - | - |
| Ethernet6 | P2P_LINK_TO_BORDERLEAF1-DC2_Ethernet5 | routed | - | 192.168.203.36/31 | default | 1550 | False | - | - |
| Ethernet7 | P2P_LINK_TO_BORDERLEAF2-DC2_Ethernet5 | routed | - | 192.168.203.52/31 | default | 1550 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.201.13/32 |
...
| 192.168.203.5 | 65201 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.203.11 | 65201 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.203.17 | 65202 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.203.23 | 65202 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.203.37 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.203.53 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
router bgp 65200
   ...
   neighbor 192.168.203.17 remote-as 65202
   neighbor 192.168.203.17 description leaf3-DC2_Ethernet5
   neighbor 192.168.203.23 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.23 remote-as 65202
   neighbor 192.168.203.23 description leaf4-DC2_Ethernet5
   neighbor 192.168.203.37 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.37 remote-as 65103
   neighbor 192.168.203.37 description borderleaf1-DC2_Ethernet5
   neighbor 192.168.203.53 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.53 remote-as 65103
   neighbor 192.168.203.53 description borderleaf2-DC2_Ethernet5
